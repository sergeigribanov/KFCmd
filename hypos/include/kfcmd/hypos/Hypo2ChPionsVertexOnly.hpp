...
/**
 * @file Hypo2ChPionsVertexOnly.hpp
 *
 * @brief Hypo2ChPionsVertexOnly class definition
 *
 * @ingroup KFCmd
 *
...
#ifndef _KFCmd_Hypo2ChPionsVertexOnly_HPP_
#define _KFCmd_Hypo2ChPionsVertexOnly_HPP_
#include "kfcmd/core/Hypothesis.hpp"

namespace kfcmd {
  namespace hypos {
    /**
     * Implementation of (pi+, pi-) hypothesis
     * Alternative photon parametrization (without taking vertex into account)
     */
    class Hypo2ChPionsVertexOnly : public kfcmd::core::Hypothesis {
    public:
      //! A constructor
      /*!
