...
#ifndef _KFCmd_Hypo4ChPions_HPP_
#define _KFCmd_Hypo4ChPions_HPP_
...
namespace kfcmd {
  namespace hypos {
     ...
     */
    class Hypo4ChPions : public kfcmd::core::Hypothesis {
    public:
      //! A constructor
      /*!
       ...
       */
      Hypo4ChPions(double, double, long = 20, double = 1.e-4);
      //! A destructor
