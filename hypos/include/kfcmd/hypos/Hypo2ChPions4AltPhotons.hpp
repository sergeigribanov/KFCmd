...
#ifndef _KFCmd_Hypo2ChPions4AltPhotons_HPP_
#define _KFCmd_Hypo2ChPions4AltPhotons_HPP_
...
namespace kfcmd {
  namespace hypos {
     ...
     */
    class Hypo2ChPions4AltPhotons : public kfcmd::core::Hypothesis {
    public:
      //! A constructor
      /*!
       ...
       */
      Hypo2ChPions4AltPhotons(double, double, long = 20, double = 1.e-4);
      //! A destructor
      virtual ~Hypo2ChPions4AltPhotons();
    };
  } // namespace core
}  // namespace kfcmd
