...
#ifndef _KFCmd_Hypo2ChPions3PhotonsLostPhoton_HPP_
#define _KFCmd_Hypo2ChPions3PhotonsLostPhoton_HPP_
...
namespace kfcmd {
  namespace hypos {
     ...
     */
    class Hypo2ChPions3PhotonsLostPhoton : public kfcmd::core::Hypothesis {
    public:
      //! A constructor
      /*!
       ...
       */
      Hypo2ChPions3PhotonsLostPhoton(double, double, long = 20, double = 1.e-4);
      //! A destructor
      virtual ~Hypo2ChPions3PhotonsLostPhoton();
    };
  } // namespace core
}  // namespace kfcmd
