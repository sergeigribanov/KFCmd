...
#include "kfcmd/hypos/Hypo2ChPionsPiPlusPiMinusLost.hpp"

#include "kfcmd/core/PiMinusMeson.hpp"
#include "kfcmd/core/PiPlusMeson.hpp"

kfcmd::hypos::Hypo2ChPionsPiPlusPiMinusLost::Hypo2ChPionsPiPlusPiMinusLost(double energy, double magnetField, long nIter,
                                  double tolerance)
...
kfcmd::hypos::Hypo2ChPionsPiPlusPiMinusLost::~Hypo2ChPionsPiPlusPiMinusLost() {}
