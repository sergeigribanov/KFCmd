...
/**
 * @file Hypo2ChPions.cpp
 *
 * @brief Implementation of Hypo2ChPions methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo2ChPions.hpp"

using namespace kfcmd::hypos;

Hypo2ChPions::Hypo2ChPions(double energy,
