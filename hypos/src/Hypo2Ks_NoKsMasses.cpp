...
/**
 * @file Hypo2Ks_NoKsMasses.cpp
 *
 * @brief Implementation of Hypo2Ks_NoKsMasses methods
 *
 * @ingroup KFCmd
 *
...
kfcmd::hypos::Hypo2Ks_NoKsMasses::Hypo2Ks_NoKsMasses(double energy, double magneticField,
  ...
  addMomentumConstraints("momentum-vtx0", {getParticle("origin")},
                         {getParticle("ks1"), getParticle("ks2")});
...
kfcmd::hypos::Hypo2Ks_NoKsMasses::~Hypo2Ks_NoKsMasses() {}
