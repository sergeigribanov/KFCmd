...
/**
 * @file Hypo2ChPionsAltPhoton.cpp
 *
 * @brief Implementation of Hypo2ChPionsAltPhoton methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo2ChPionsAltPhoton.hpp"

using namespace kfcmd::hypos;

Hypo2ChPionsAltPhoton::Hypo2ChPionsAltPhoton(double energy,
  ...
  addEnergyMomentumConstraints("em-vtx0", {getParticle("origin")},
                               {pip, pim, getParticle("g0")});
  addOutputVertexConstraintsXYZ("pi+", "vtx0");
  addOutputVertexConstraintsXYZ("pi-", "vtx0");
}

Hypo2ChPionsAltPhoton::~Hypo2ChPionsAltPhoton() {}
