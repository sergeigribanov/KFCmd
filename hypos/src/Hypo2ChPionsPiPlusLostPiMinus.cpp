...
#include "kfcmd/hypos/Hypo2ChPionsPiPlusLostPiMinus.hpp"

#include "kfcmd/core/PiMinusMeson.hpp"
#include "kfcmd/core/PiPlusMeson.hpp"

kfcmd::hypos::Hypo2ChPionsPiPlusLostPiMinus::Hypo2ChPionsPiPlusLostPiMinus(double energy, double magnetField, long nIter,
                                  double tolerance)
...
kfcmd::hypos::Hypo2ChPionsPiPlusLostPiMinus::~Hypo2ChPionsPiPlusLostPiMinus() {}
