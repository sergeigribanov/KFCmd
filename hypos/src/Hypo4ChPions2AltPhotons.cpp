...
/**
 * @file Hypo4ChPions2AltPhotons.cpp
 *
 * @brief Implementation of Hypo4ChPions2AltPhotons methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo4ChPions2AltPhotons.hpp"

using namespace kfcmd::hypos;

Hypo4ChPions2AltPhotons::Hypo4ChPions2AltPhotons(double energy,
                                           double magnetField,
...
Hypo4ChPions2AltPhotons::~Hypo4ChPions2AltPhotons() {}
