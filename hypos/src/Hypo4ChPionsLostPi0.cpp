...
/**
 * @file Hypo4ChPionsLostPi0.cpp
 *
 * @brief Implementation of Hypo4ChPionsLostPi0 methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo4ChPionsLostPi0.hpp"

using namespace kfcmd::hypos;

Hypo4ChPionsLostPi0::Hypo4ChPionsLostPi0(double energy,
                                           double magnetField,
...
Hypo4ChPionsLostPi0::~Hypo4ChPionsLostPi0() {}
