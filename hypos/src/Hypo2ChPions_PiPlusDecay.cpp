...
/**
 * @file Hypo2ChPions2Photons_PiPlusDecay.cpp
 *
 * @brief Implementation of Hypo2ChPions2Photons_PiPlusDecay methods
 *
 * @ingroup KFCmd
 *
...
Hypo2ChPions2Photons_PiPlusDecay::~Hypo2ChPions2Photons_PiPlusDecay() {}
