...
/**
 * @file Hypo4ChPions2AltPhotonsLostPi0.cpp
 *
 * @brief Implementation of Hypo4ChPions2AltPhotonsLostPi0 methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo4ChPions2AltPhotonsLostPi0.hpp"

using namespace kfcmd::hypos;

Hypo4ChPions2AltPhotonsLostPi0::Hypo4ChPions2AltPhotonsLostPi0(double energy,
                                           double magnetField,
  ...
  addAltPhoton("g0");
  addAltPhoton("g1");
  const double m_pi0 = TDatabasePDG::Instance()->GetParticle(111)->Mass();
  addParticlePxPyPz("pi0", m_pi0);
  addConstantMomentumParticle("origin", energy, Eigen::Vector3d::Zero());
  addEnergyMomentumConstraints("em-vtx0", {getParticle("origin")},
                               {pipl0, pipl1, pimi0, pimi1, getParticle("g0"),
                                getParticle("g1"), getParticle("pi0")});
  addOutputVertexConstraintsXYZ("pi+_0", "vtx0");
  addOutputVertexConstraintsXYZ("pi+_1", "vtx0");
  addOutputVertexConstraintsXYZ("pi-_0", "vtx0");
  addOutputVertexConstraintsXYZ("pi-_1", "vtx0");
  addMassConstraint("m-pi0-constraint", m_pi0, {"g0", "g1"});
  disableConstraint("m-pi0-constraint");
}

Hypo4ChPions2AltPhotonsLostPi0::~Hypo4ChPions2AltPhotonsLostPi0() {}
