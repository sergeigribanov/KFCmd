...
#include "kfcmd/hypos/Hypo2ChPionsKsKs.hpp"
...
kfcmd::hypos::Hypo2ChPionsKsKs::Hypo2ChPionsKsKs(double energy, double magnetField,
  ...
  addChargedParticle(new kfcmd::core::PiPlusMeson("pi+_2"));
  addChargedParticle(new kfcmd::core::PiMinusMeson("pi-_2"));
...
kfcmd::hypos::Hypo2ChPionsKsKs::~Hypo2ChPionsKsKs() {}
