...
/**
 * @file Hypo2ChPions4AltPhotonsPi0Lost.cpp
 *
 * @brief Implementation of Hypo2ChPions4AltPhotonsPi0Lost methods
 *
 * @ingroup KFCmd
 *
...
#include "kfcmd/hypos/Hypo2ChPions4AltPhotonsPi0Lost.hpp"

using namespace kfcmd::hypos;

Hypo2ChPions4AltPhotonsPi0Lost::Hypo2ChPions4AltPhotonsPi0Lost(double energy,
  ...
  addParticlePxPyPz("pi0", pi0_mass);
...
Hypo2ChPions4AltPhotonsPi0Lost::~Hypo2ChPions4AltPhotonsPi0Lost() {}
