...
KFCmd::Hypothesis::Hypothesis(double energy, double magnetField,
  ...
  addConstraint(new KFBase::MomentumConstraint("#constraint-pz", KFBase::MOMENT_Z, 0));
  addConstraint(new KFBase::MomentumConstraint("#constraint-pe", KFBase::MOMENT_E, energy));
...
void KFCmd::Hypothesis::disableVertexComponent(const std::string& vertexName,
...
void KFCmd::Hypothesis::enableVertexComponent(const std::string& vertexName,
					      KFBase::VERTEX_COMPONENT component) {
  switch (component) {
  case KFBase::VERTEX_X:
    enableCommonParams("#" + vertexName + "-x");
...
void KFCmd::Hypothesis::releaseVertexComponent(const std::string& vertexName,
					       KFBase::VERTEX_COMPONENT component) {
  switch (component) {
  case KFBase::VERTEX_X:
...
void KFCmd::Hypothesis::enableChargedParticle(const std::string& chargedParticleName) {
...
void KFCmd::Hypothesis::addVertexConstraintsXYZ(const std::string& chargedParticleName,
						const std::string& vertexName) {
  auto vtxX = new KFBase::VertexConstraint("#" + chargedParticleName + "-constraint-x", KFBase::VERTEX_X);
  addConstraint(vtxX); 
  vtxX->setVertexCommonParams("#" + vertexName + "-x");
  auto vtxY = new KFBase::VertexConstraint("#" + chargedParticleName + "-constraint-y", KFBase::VERTEX_Y);
  addConstraint(vtxY);
  vtxY->setVertexCommonParams("#" + vertexName + "-y");
  auto vtxZ = new KFBase::VertexConstraint(chargedParticleName + "-constraint-z", KFBase::VERTEX_Z);
  addConstraint(vtxZ);
...
void KFCmd::Hypothesis::disableVertexConstraintXYZ(const std::string& chargedParticleName) {
...
void KFCmd::Hypothesis::disableVertexConstraintX(const std::string& chargedParticleName) {
  disableConstraint("#" + chargedParticleName + "-constraint-x");
}

void KFCmd::Hypothesis::disableVertexConstraintY(const std::string& chargedParticleName) {
  disableConstraint("#" + chargedParticleName + "-constraint-y");
}

void KFCmd::Hypothesis::disableVertexConstraintZ(const std::string& chargedParticleName) {
  disableConstraint("#" + chargedParticleName + "-constraint-z");
}

void KFCmd::Hypothesis::enableVertexConstraintXYZ(const std::string& chargedParticleName) {
...
void KFCmd::Hypothesis::enableVertexConstraintX(const std::string& chargedParticleName) {
  enableConstraint("#" + chargedParticleName + "-constraint-x");
}

void KFCmd::Hypothesis::enableVertexConstraintY(const std::string& chargedParticleName) {
  enableConstraint("#" + chargedParticleName + "-constraint-y");
}

void KFCmd::Hypothesis::enableVertexConstraintZ(const std::string& chargedParticleName) {
  enableConstraint("#" + chargedParticleName + "-constraint-z");
}

double KFCmd::Hypothesis::getInitialVertexX(const std::string& vertexName) const {
  return getInitialCommonParameters("#" + vertexName + "-x")(0);
}

double KFCmd::Hypothesis::getInitialVertexY(const std::string& vertexName) const {
  return getInitialCommonParameters("#" + vertexName + "-y")(0);
}

double KFCmd::Hypothesis::getInitialVertexZ(const std::string& vertexName) const {
...
double KFCmd::Hypothesis::getInitialChargedParticleTime(const std::string& chargedParticleName) const {
