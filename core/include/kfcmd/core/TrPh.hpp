...
namespace kfcmd {
  namespace core {
    ...
    public:
      ...
      Float_t  bs_recotime;
      Int_t    bs_ncomp;
      Float_t  bs_compSigma[50][2];   //[bs_ncomp]
      Int_t    bs_phflag[50];   //[bs_nph]
      Int_t    bs_phconv[50];   //[bs_nph]
      Float_t  bs_phphi[50];   //[bs_nph]
      Float_t  bs_phth[50];   //[bs_nph]
      Float_t  bs_phrho[50];   //[bs_nph]
      Float_t  bs_phen[50];   //[bs_nph]
      Float_t  bs_phlxe[50];   //[bs_nph]
      Float_t  bs_phcsi[50];   //[bs_nph]
      Float_t  bs_pherr[50][3];   //[bs_nph]
      Float_t  bs_phSigma[50][2];   //[bs_nph]
      Float_t  bs_phphi0[50];   //[bs_nph]
      Float_t  bs_phth0[50];   //[bs_nph]
      Float_t  bs_phen0[50];   //[bs_nph]
      Float_t  bs_tinout_phi[20][2];   //[bs_nt]
      Float_t  bs_tinout_theta[20][2];   //[bs_nt]
      Float_t  bs_tlxe[20];   //[bs_nt]
      Float_t  bs_tcsi[20];   //[bs_nt]
      Float_t  bs_tSigma[20][2];   //[bs_nt]
      Float_t  ebeam;
      Float_t  emeas;
      Float_t  demeas;
      Float_t  emeas0;
      ...
      Int_t    nks_total;
      Int_t    nks;
      Int_t    ksvind[20][2];   //[nks]
      Int_t    kstype[20];   //[nks]
      Int_t    ksfstatus[20];   //[nks]
      Float_t  ksvchi[20];   //[nks]
      Float_t  ksvxyz[20][3];   //[nks]
      Float_t  ksminv[20];   //[nks]
      Float_t  ksalign[20];   //[nks]
      Float_t  kstlen[20];   //[nks]
      Float_t  ksdpsi[20];   //[nks]
      Float_t  kslen[20];   //[nks]
      Float_t  ksz0[20];   //[nks]
      Float_t  ksphi[20];   //[nks]
      Float_t  ksth[20];   //[nks]
      Float_t  ksptot[20];   //[nks]
      Float_t  kspiphi[20][2];   //[nks]
      Float_t  kspith[20][2];   //[nks]
      Float_t  kspipt[20][2];   //[nks]
      Float_t  kserr[20][3][3];   //[nks]
      Int_t    ntlxe_total;
      Int_t    ntlxe;
      ...
      TBranch *b_bs_nph;   //!
      TBranch *b_bs_nt;   //!
      TBranch *b_bs_recotime;   //!
      TBranch *b_bs_ncomp;   //!
      TBranch *b_bs_compSigma;   //!
      TBranch *b_bs_phflag;   //!
      TBranch *b_bs_phconv;   //!
      TBranch *b_bs_phphi;   //!
      TBranch *b_bs_phth;   //!
      ...
      TBranch *b_bs_phcsi;   //!
      TBranch *b_bs_pherr;   //!
      TBranch *b_bs_phSigma;   //!
      TBranch *b_bs_phphi0;   //!
      TBranch *b_bs_phth0;   //!
      TBranch *b_bs_phen0;   //!
      TBranch *b_bs_tinout_phi;   //!
      TBranch *b_bs_tinout_theta;   //!
      TBranch *b_bs_tlxe;   //!
      TBranch *b_bs_tcsi;   //!
      TBranch *b_bs_tSigma;   //!
      TBranch *b_ebeam;   //!
