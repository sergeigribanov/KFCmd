...
void kfcmd::core::TrPh::Init(TTree *tree) {
  ...
  fChain->SetBranchAddress("bs_nph", &bs_nph, &b_bs_nph);
  fChain->SetBranchAddress("bs_nt", &bs_nt, &b_bs_nt);
  fChain->SetBranchAddress("bs_recotime", &bs_recotime, &b_bs_recotime);
  fChain->SetBranchAddress("bs_ncomp", &bs_ncomp, &b_bs_ncomp);
  fChain->SetBranchAddress("bs_compSigma", bs_compSigma, &b_bs_compSigma);
  fChain->SetBranchAddress("bs_phflag", bs_phflag, &b_bs_phflag);
  fChain->SetBranchAddress("bs_phconv", bs_phconv, &b_bs_phconv);
  fChain->SetBranchAddress("bs_phphi", bs_phphi, &b_bs_phphi);
  fChain->SetBranchAddress("bs_phth", bs_phth, &b_bs_phth);
  fChain->SetBranchAddress("bs_phrho", bs_phrho, &b_bs_phrho);
  fChain->SetBranchAddress("bs_phen", bs_phen, &b_bs_phen);
  fChain->SetBranchAddress("bs_phlxe", bs_phlxe, &b_bs_phlxe);
  fChain->SetBranchAddress("bs_phcsi", bs_phcsi, &b_bs_phcsi);
  fChain->SetBranchAddress("bs_pherr", bs_pherr, &b_bs_pherr);
  fChain->SetBranchAddress("bs_phSigma", bs_phSigma, &b_bs_phSigma);
  fChain->SetBranchAddress("bs_phphi0", bs_phphi0, &b_bs_phphi0);
  fChain->SetBranchAddress("bs_phth0", bs_phth0, &b_bs_phth0);
  fChain->SetBranchAddress("bs_phen0", bs_phen0, &b_bs_phen0);
  fChain->SetBranchAddress("bs_tinout_phi", bs_tinout_phi, &b_bs_tinout_phi);
  fChain->SetBranchAddress("bs_tinout_theta", bs_tinout_theta, &b_bs_tinout_theta);
  fChain->SetBranchAddress("bs_tlxe", bs_tlxe, &b_bs_tlxe);
  fChain->SetBranchAddress("bs_tcsi", bs_tcsi, &b_bs_tcsi);
  fChain->SetBranchAddress("bs_tSigma", bs_tSigma, &b_bs_tSigma);
